...
import { buildUrlWithQuery, isExternalUrl, joinUrl, objectToSearchParams, stripLocalePrefix, withLocalePrefix, withQuery } from "./url";

describe("url helpers", () => {
  it("serializes params, skipping nullish/empty and expanding arrays", () => {
    const qs = objectToSearchParams({ page: 2, search: "", skip: null, none: undefined, ids: [1, 2], nested: { a: 1 } }).toString();
