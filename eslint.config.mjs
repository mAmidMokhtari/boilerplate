...
const depConstraints = [
  { sourceTag: "type:app", onlyDependOnLibsWithTags: ["type:service", "type:ui", "type:auth", "type:middleware", "type:config", "type:dto", "type:model", "type:util", "type:enum", "type:testing"] },
  { sourceTag: "type:e2e", onlyDependOnLibsWithTags: ["type:app", "type:config", "type:util"] },
  { sourceTag: "type:service", onlyDependOnLibsWithTags: ["type:config", "type:dto", "type:model", "type:util", "type:enum"] },
  { sourceTag: "type:auth", onlyDependOnLibsWithTags: ["type:config", "type:service", "type:model", "type:util"] },
  { sourceTag: "type:middleware", onlyDependOnLibsWithTags: ["type:config"] },
  { sourceTag: "type:ui", onlyDependOnLibsWithTags: ["type:util", "type:config", "type:model", "type:dto"] },
  ...
  { sourceTag: "type:testing", onlyDependOnLibsWithTags: ["type:service", "type:ui", "type:config", "type:model", "type:dto", "type:util"] },
 ...
 */
const PHYSICAL_TAILWIND = "(^|[\\s\"'`])(-?(ml|mr|pl|pr|left|right|scroll-ml|scroll-mr|scroll-pl|scroll-pr|rounded-l|rounded-r|rounded-tl|rounded-tr|rounded-bl|rounded-br|border-l|border-r)-[\\w\\[\\]/.%-]+|text-left|text-right|float-left|float-right|clear-left|clear-right)([\\s\"'`]|$)";
  ...
  },
  {
    ...
    rules: {
      ...
      "no-restricted-imports": [
        ...
        {
          patterns: [
            { group: ["@repo/*/src/*"], message: "Deep imports are not allowed. Import from the package root or a declared subpath." },
            { group: ["../../../libs/*", "../../../../libs/*"], message: "Import libs by package name (@repo/...)." },
          ],
        },
      ],
    },
    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          ...
          message: "Use logical Tailwind utilities (ms-/me-/ps-/pe-/start-/end-/text-start/text-end) instead of physical ones.",
        },
        {
